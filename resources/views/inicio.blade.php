...
@section('cabecera', 'Abarrotes puntode venta - Tu mejor aliado')
...
<div class="hero min-h-screen" style="background-image: url(https://s3.us-west-2.amazonaws.com/images.unsplash.com/application-1701622670745-04860c39053dimage);">
 ...
 <div class="max-w-md">
 <h1 class="mb-5 text-5xl font-bold">Tenemos lo que necesitas!</h1>
 <p class="mb-5">Nuestra responsabilidad con nuestros aliados nos impulsa a seguir cada dia</p>
